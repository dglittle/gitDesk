...
_.run(function () {
    ...
    rpc.postIssueJob = function (u, company, team, category, subcategory, issueUrl, skills, budget, visibility) {
        ...
        var info = {
            ...
            questions : [
                ...
                'how would you trim the whitespace from the string s using a regular expression?'
            ]
        }
        ...
        var jobParams = {
            ...
            title : do_template('Add enhancement in open source {{skills[0]}} project: {{issueTitle}}', info),
